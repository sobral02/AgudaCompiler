...
def main():
    ...
    try:
        ...
        # Validação semântica
        validator = Validator(max_errors=5)  # valor ajustável, nunca deve ser 0!
        ...
        print("DEBUG: generate_llvm_code retornou")  # PRINT 9
        # ------------------------------
        ...
        sys.exit(1)
    except Exception as e:  # Catch any other exceptions, including those from codegen
