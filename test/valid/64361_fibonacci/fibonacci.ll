...
then.1:
  ...
  %"fib_call" = call i32 @"fib"(i32 %"subtmp")
  %"n_val.3" = load i32, i32* %"n_ptr"
  %"subtmp.1" = sub i32 %"n_val.3", 2
  %"fib_call.1" = call i32 @"fib"(i32 %"subtmp.1")
  %"addtmp" = add i32 %"fib_call", %"fib_call.1"
  br label %"merge.1"
merge.1:
...
{
entry:
  %"fib_call" = call i32 @"fib"(i32 0)
  %"fmtptr" = getelementptr [3 x i8], [3 x i8]* @".printf_fmt_int", i32 0, i32 0
  %"printf_call" = call i32 (i8*, ...) @"printf"(i8* %"fmtptr", i32 %"fib_call")
  %"fib_call.1" = call i32 @"fib"(i32 1)
  %"fmtptr.1" = getelementptr [3 x i8], [3 x i8]* @".printf_fmt_int", i32 0, i32 0
  %"printf_call.1" = call i32 (i8*, ...) @"printf"(i8* %"fmtptr.1", i32 %"fib_call.1")
  %"fib_call.2" = call i32 @"fib"(i32 5)
  %"fmtptr.2" = getelementptr [3 x i8], [3 x i8]* @".printf_fmt_int", i32 0, i32 0
  %"printf_call.2" = call i32 (i8*, ...) @"printf"(i8* %"fmtptr.2", i32 %"fib_call.2")
  %"fib_call.3" = call i32 @"fib"(i32 10)
  %"fmtptr.3" = getelementptr [3 x i8], [3 x i8]* @".printf_fmt_int", i32 0, i32 0
  %"printf_call.3" = call i32 (i8*, ...) @"printf"(i8* %"fmtptr.3", i32 %"fib_call.3")
  ret void
}
