...
loop.body:
  ...
  br label %"loop.cond"
loop.end:
  %"counter_val.1" = load i32, i32* %"counter"
  ret i32 %"counter_val.1"
}

define void @"aguda_main"()
{
entry:
  %"counterTest_call" = call i32 @"counterTest"(i32 7)
  %"fmtptr" = getelementptr [3 x i8], [3 x i8]* @".printf_fmt_int", i32 0, i32 0
  %"printf_call" = call i32 (i8*, ...) @"printf"(i8* %"fmtptr", i32 %"counterTest_call")
  ret void
}
