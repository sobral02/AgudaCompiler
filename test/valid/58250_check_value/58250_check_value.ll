...
entry:
  %"negtmp" = sub i32 0, 5
  %"check_sign_call" = call i1 @"check_sign"(i32 %"negtmp")
  ret i1 %"check_sign_call"
}

define void @"aguda_main"()
{
entry:
  %"result_call" = call i1 @"result"()
  br i1 %"result_call", label %"print_true", label %"print_false"
print_true:
